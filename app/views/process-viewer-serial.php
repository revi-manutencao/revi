            ...
            <ul class="blocklist block-full">
                <?php if (count($arrEtapas) > 0)
                    foreach ($arrEtapas as $i => $dados) { ?>
                        ...
                        <?php
                            if ($i < count($arrEtapas) -1){
                                ?>
                                <img src="<?=asset('images/icons/arrow.png')?>" style="width: 30%; max-width: 60px;">
                                <?php
                            }
                        ?>
                    <?php } ?>
